...
})({"geUin":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "1adf131afd23351f";
...
(function(window) {
    const OGWidgets = {
        ...
        init: function() {
            ...
            const widgets = document.querySelectorAll(`a[data-og-widget][href^="${(0, _routes.getExternalUrl)()}"]`);
            widgets.forEach(this.initializeWidget.bind(this));
        },
        registerListener: function() {
            if (!this.listenerRegistered) {
                (0, _messenger.register)((ev)=>{
        ...
        initializeWidget: function(element) {
            if (this.processedWidgets.includes(element)) return;
        ...
        getWidgetCallbackUrl: function(element) {
            let url;
            const { href , dataset: { ogCode  } ,  } = element;
            if ((0, _routes.getTripSlugFromUrl)(href)) url = (0, _routes.tripLink)((0, _routes.getTripSlugFromUrl)(href));
            else if ((0, _routes.getHostSlugFromUrl)(href)) url = (0, _routes.hostLink)((0, _routes.getHostSlugFromUrl)(href));
